...
Go backend for the DataForge AI Level 1 MVP. It supports image classification dataset projects, CSV and ZIP upload, ML-service analysis, dashboard APIs, review queue, recommendations, roadmap, object image serving, curated ZIP export, and the bundled Next.js frontend.
...
The frontend will be available at `http://localhost:3000`; the API will be available at `http://localhost:8080`; the ML service will be available at `http://localhost:8000`.
...
- No auth or MinIO is included in this Level 1 pass.
